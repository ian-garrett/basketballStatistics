...
FROM player p join player_stats s ON p.id=s.player_id ORDER BY s.points_per_game DESC LIMIT 10";
...
<p>
<span><button><a href="index.html">Home</a></button> <button><a href="topPoints.php">Reset</a></button></span>  
