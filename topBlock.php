...
FROM player p join player_stats s ON p.id=s.player_id ORDER BY s.blocks DESC LIMIT 10";
...
<p>
<span><button><a href="index.html">Home</a></button> <button><a href="topBlock.php">Reset</a></button></span>  
