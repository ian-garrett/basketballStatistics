...
FROM player p join player_stats s ON p.id=s.player_id ORDER BY s.rebounds DESC LIMIT 10";
...
<p>
<span><button><a href="index.html">Home</a></button> <button><a href="topRebound.php">Reset</a></button></span>  
