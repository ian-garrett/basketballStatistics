...
FROM player p join player_stats s ON p.id=s.player_id WHERE (s.points_per_game>=10) AND (s.rebounds>=10) AND (s.assists>=10)
...
<p>
 <span><button><a href="index.html">Home</a></button> <button><a href="tripleDouble.php">Reset</a></button></span>  
